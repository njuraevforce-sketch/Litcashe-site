...
window.LC_I18N = (function(){
  const dict = {
    "ru": {
      ...
      "withdraw_balance_label": "Баланс:",
      "withdraw_title": "Заявка на вывод",
      "withdraw_wallet_placeholder": "TRC20-кошелёк",
      "withdraw_amount_placeholder": "Сумма к выводу, USDT",
      "withdraw_submit_btn": "Отправить заявку",
      "withdraw_note": "Первый вывод — через 5 дней после активации. Далее — не чаще 1 раза в 24 часа.",
      "withdraw_history_title": "История заявок",
      "withdraw_table_date": "Дата",
      "withdraw_table_amount": "Сумма",
      "withdraw_table_network": "Сеть",
      "withdraw_table_status": "Статус",
      "withdraw_table_tx": "TX",
      "withdraw_table_action": "Действие",
      "withdraw_loading": "Загрузка…",
      "withdraw_no_data": "Пока нет заявок",
      "withdraw_status_paid": "подтверждено",
      "withdraw_status_rejected": "отклонено",
      "withdraw_status_pending": "ожидание",
      "withdraw_cancel_btn": "Отменить",
    ...
    "en": {
      ...
      "deposit_wallet_label": "Unified wallet (TRC20):",
      ...
      "deposit_note": "After network confirmation, the balance will be replenished automatically.",

      "withdraw_balance_label": "Balance:",
      "withdraw_title": "Withdrawal request",
      "withdraw_wallet_placeholder": "TRC20 wallet",
      "withdraw_amount_placeholder": "Withdrawal amount, USDT",
      "withdraw_submit_btn": "Submit request",
      "withdraw_note": "First withdrawal — 5 days after activation. Then — no more than once every 24 hours.",
      "withdraw_history_title": "Request history",
      "withdraw_table_date": "Date",
      "withdraw_table_amount": "Amount",
      "withdraw_table_network": "Network",
      "withdraw_table_status": "Status",
      "withdraw_table_tx": "TX",
      "withdraw_table_action": "Action",
      "withdraw_loading": "Loading...",
      "withdraw_no_data": "No requests yet",
      "withdraw_status_paid": "confirmed",
    ...
    "cn": {
      ...
      "page_title_deposit": "存款 — Litcash",
      "page_title_withdraw": "提款 — Litcash",
      ...
      "deposit_submit_btn": "确认存款",
      "deposit_note": "网络确认后，余额将自动充值。",

      "withdraw_balance_label": "余额:",
      "withdraw_title": "提款申请",
      "withdraw_wallet_placeholder": "TRC20 钱包",
      "withdraw_amount_placeholder": "提款金额, USDT",
      "withdraw_submit_btn": "提交申请",
      "withdraw_note": "首次提现 — 激活后5天。然后 — 每24小时不超过一次。",
      "withdraw_history_title": "申请历史",
      "withdraw_table_date": "日期",
      "withdraw_table_amount": "金额",
      "withdraw_table_network": "网络",
      "withdraw_table_status": "状态",
      "withdraw_table_tx": "交易",
      "withdraw_table_action": "操作",
      "withdraw_loading": "加载中…",
      "withdraw_no_data": "暂无申请",
      "withdraw_status_paid": "已确认",
      "withdraw_status_rejected": "已拒绝",
      "withdraw_status_pending": "等待中",
      "withdraw_cancel_btn": "取消",
    ...
    "es": {
      ...
      "page_title_withdraw": "Retiro — Litcash",
      
      "deposit_title": "Depósito",
      "deposit_wallet_label": "Billetera unificada (TRC20):",
      ...
      "deposit_note": "Después de la confirmación de la red, el saldo se repondrá automáticamente.",

      "withdraw_balance_label": "Saldo:",
      "withdraw_title": "Solicitud de retiro",
      "withdraw_wallet_placeholder": "Billetera TRC20",
      "withdraw_amount_placeholder": "Cantidad a retirar, USDT",
      "withdraw_submit_btn": "Enviar solicitud",
      "withdraw_note": "Primer retiro — 5 días después de la activación. Luego — no más de una vez cada 24 horas.",
      "withdraw_history_title": "Historial de solicitudes",
      "withdraw_table_date": "Fecha",
      "withdraw_table_amount": "Cantidad",
      "withdraw_table_network": "Red",
      "withdraw_table_status": "Estado",
      "withdraw_table_tx": "TX",
      "withdraw_table_action": "Acción",
      "withdraw_loading": "Cargando…",
      "withdraw_no_data": "Aún no hay solicitudes",
      "withdraw_status_paid": "confirmado",
      "withdraw_status_rejected": "rechazado",
      "withdraw_status_pending": "pendiente",
      "withdraw_cancel_btn": "Cancelar",
      ...
      "no_data": "Sin datos",
      "language": "Idioma",
      "language_switch": "Selección de idioma",
    ...
    "fr": {
      ...
      "deposit_title": "Dépôt",
      "deposit_wallet_label": "Portefeuille unifié (TRC20) :",
      ...
      "deposit_note": "Après confirmation du réseau, le solde sera rechargé automatiquement.",

      "withdraw_balance_label": "Solde :",
      "withdraw_title": "Demande de retrait",
      "withdraw_wallet_placeholder": "Portefeuille TRC20",
      "withdraw_amount_placeholder": "Montant du retrait, USDT",
      "withdraw_submit_btn": "Soumettre la demande",
      "withdraw_note": "Premier retrait — 5 jours après l'activation. Ensuite — pas plus d'une fois toutes les 24 heures.",
      "withdraw_history_title": "Historique des demandes",
      "withdraw_table_date": "Date",
      "withdraw_table_amount": "Montant",
      "withdraw_table_network": "Réseau",
      "withdraw_table_status": "Statut",
      "withdraw_table_tx": "TX",
      "withdraw_table_action": "Action",
      "withdraw_loading": "Chargement…",
      "withdraw_no_data": "Aucune demande pour l'instant",
      "withdraw_status_paid": "confirmé",
      "withdraw_status_rejected": "rejeté",
      "withdraw_status_pending": "en attente",
      "withdraw_cancel_btn": "Annuler",
      ...
      "language": "Langue",
      "language_switch": "Sélection de la langue",
    ...
    "de": {
      ...
      "deposit_wallet_label": "Einheitliche Wallet (TRC20):",
      ...
      "deposit_note": "Nach der Netzwerkbestätigung wird das Guthaben automatisch aufgeladen.",

      "withdraw_balance_label": "Guthaben:",
      "withdraw_title": "Auszahlungsanfrage",
      "withdraw_wallet_placeholder": "TRC20-Wallet",
      "withdraw_amount_placeholder": "Auszahlungsbetrag, USDT",
      "withdraw_submit_btn": "Anfrage senden",
      "withdraw_note": "Erste Auszahlung — 5 Tage nach Aktivierung. Dann — nicht öfter als einmal alle 24 Stunden.",
      "withdraw_history_title": "Anfrageverlauf",
      "withdraw_table_date": "Datum",
      "withdraw_table_amount": "Betrag",
      "withdraw_table_network": "Netzwerk",
      "withdraw_table_status": "Status",
      "withdraw_table_tx": "TX",
      "withdraw_table_action": "Aktion",
      "withdraw_loading": "Lädt…",
      "withdraw_no_data": "Noch keine Anfragen",
      "withdraw_status_paid": "bestätigt",
      "withdraw_status_rejected": "abgelehnt",
      "withdraw_status_pending": "ausstehend",
      "withdraw_cancel_btn": "Stornieren",
      ...
      "dashboard_daily_reward_desc": "Betrag pro day nach Level",
    ...
    "pt": {
      ...
      "page_title_deposit": "Depósito — Litcash",
      "page_title_withdraw": "Retirada — Litcash",
      
      "deposit_title": "Depósito",
      "deposit_wallet_label": "Carteira unificada (TRC20):",
      "deposit_copy_btn": "Copiar",
      "deposit_amount_placeholder": "Valor, USDT",
      "deposit_txid_placeholder": "TXID (hash da transação)",
      "deposit_submit_btn": "Confirmar depósito",
      "deposit_note": "Após confirmação da rede, o saldo será reabastecido automaticamente.",

      "withdraw_balance_label": "Saldo:",
      "withdraw_title": "Solicitação de retirada",
      "withdraw_wallet_placeholder": "Carteira TRC20",
      "withdraw_amount_placeholder": "Valor da retirada, USDT",
      "withdraw_submit_btn": "Enviar solicitação",
      "withdraw_note": "Primeira retirada — 5 dias após ativação. Depois — não mais que uma vez a cada 24 horas.",
      "withdraw_history_title": "Histórico de solicitações",
      "withdraw_table_date": "Data",
      "withdraw_table_amount": "Valor",
      "withdraw_table_network": "Rede",
      "withdraw_table_status": "Status",
      "withdraw_table_tx": "TX",
      "withdraw_table_action": "Ação",
      "withdraw_loading": "Carregando…",
      "withdraw_no_data": "Nenhuma solicitação ainda",
      "withdraw_status_paid": "confirmado",
      "withdraw_status_rejected": "rejeitado",
      "withdraw_status_pending": "pendente",
      "withdraw_cancel_btn": "Cancelar",
      ...
      "no_data": "Sem dados",
      "language": "Idioma",
      "language_switch": "Seleção de idioma",
    ...
    "ar": {
      ...
      "deposit_title": "إيداع",
      "deposit_wallet_label": "محفظة موحدة (TRC20):",
      ...
      "deposit_note": "بعد تأكيد الشبكة، سيتم تجديد الرصيد تلقائياً.",

      "withdraw_balance_label": "الرصيد:",
      "withdraw_title": "طلب سحب",
      "withdraw_wallet_placeholder": "محفظة TRC20",
      "withdraw_amount_placeholder": "مبلغ السحب, USDT",
      "withdraw_submit_btn": "إرسال الطلب",
      "withdraw_note": "أول سحب — بعد 5 أيام من التفعيل. ثم — لا أكثر من مرة كل 24 ساعة.",
      "withdraw_history_title": "سجل الطلبات",
      "withdraw_table_date": "التاريخ",
      "withdraw_table_amount": "المبلغ",
      "withdraw_table_network": "الشبكة",
      "withdraw_table_status": "الحالة",
      "withdraw_table_tx": "TX",
      "withdraw_table_action": "الإجراء",
      "withdraw_loading": "جاري التحميل…",
      "withdraw_no_data": "لا توجد طلبات حتى الآن",
      "withdraw_status_paid": "تم التأكيد",
      "withdraw_status_rejected": "مرفوض",
      "withdraw_status_pending": "قيد الانتظار",
      "withdraw_cancel_btn": "إلغاء",
    ...
    "ja": {
      ...
      "deposit_title": "入金",
      "deposit_wallet_label": "統一ウォレット (TRC20):",
      "deposit_copy_btn": "コピー",
      "deposit_amount_placeholder": "金額, USDT",
      "deposit_txid_placeholder": "TXID (トランザクションハッシュ)",
      "deposit_submit_btn": "入金を確認",
      "deposit_note": "ネットワーク確認後、残高は自動的に補充されます。",

      "withdraw_balance_label": "残高:",
      "withdraw_title": "出金リクエスト",
      "withdraw_wallet_placeholder": "TRC20ウォレット",
      "withdraw_amount_placeholder": "出金額, USDT",
      "withdraw_submit_btn": "リクエストを送信",
      "withdraw_note": "初回出金 — 有効化後5日。その後 — 24時間に1回まで。",
      "withdraw_history_title": "リクエスト履歴",
      "withdraw_table_date": "日付",
      "withdraw_table_amount": "金額",
      "withdraw_table_network": "ネットワーク",
      "withdraw_table_status": "ステータス",
      "withdraw_table_tx": "TX",
      "withdraw_table_action": "アクション",
      "withdraw_loading": "読み込み中…",
      "withdraw_no_data": "まだリクエストがありません",
      "withdraw_status_paid": "確認済み",
      "withdraw_status_rejected": "拒否",
      "withdraw_status_pending": "保留中",
      "withdraw_cancel_btn": "キャンセル",
    ...
    "ko": {
      ...
      "deposit_title": "입금",
      "deposit_wallet_label": "통합 지갑 (TRC20):",
      "deposit_copy_btn": "복사",
      "deposit_amount_placeholder": "금액, USDT",
      "deposit_txid_placeholder": "TXID (트랜잭션 해시)",
      "deposit_submit_btn": "입금 확인",
      "deposit_note": "네트워크 확인 후 잔액이 자동으로 충전됩니다.",

      "withdraw_balance_label": "잔액:",
      "withdraw_title": "출금 요청",
      "withdraw_wallet_placeholder": "TRC20 지갑",
      "withdraw_amount_placeholder": "출금 금액, USDT",
      "withdraw_submit_btn": "요청 제출",
      "withdraw_note": "첫 출금 — 활성화 후 5일. 그 후 — 24시간에 한 번만 가능.",
      "withdraw_history_title": "요청 기록",
      "withdraw_table_date": "날짜",
      "withdraw_table_amount": "금액",
      "withdraw_table_network": "네트워크",
      "withdraw_table_status": "상태",
      "withdraw_table_tx": "TX",
      "withdraw_table_action": "작업",
      "withdraw_loading": "로딩 중…",
      "withdraw_no_data": "아직 요청이 없습니다",
      "withdraw_status_paid": "확인됨",
      "withdraw_status_rejected": "거부됨",
      "withdraw_status_pending": "대기 중",
      "withdraw_cancel_btn": "취소",
    ...
    "tr": {
      ...
      "page_title_withdraw": "Çekme — Litcash",
      
      "deposit_title": "Yatırma",
      "deposit_wallet_label": "Birleşik cüzdan (TRC20):",
      ...
      "deposit_note": "Ağ onayından sonra, bakiye otomatik olarak yenilenecektir.",

      "withdraw_balance_label": "Bakiye:",
      "withdraw_title": "Çekme talebi",
      "withdraw_wallet_placeholder": "TRC20 cüzdan",
      "withdraw_amount_placeholder": "Çekme miktarı, USDT",
      "withdraw_submit_btn": "Talep gönder",
      "withdraw_note": "İlk çekme — aktivasyondan 5 gün sonra. Sonra — 24 saatte bir defadan fazla değil.",
      "withdraw_history_title": "Talep geçmişi",
      "withdraw_table_date": "Tarih",
      "withdraw_table_amount": "Miktar",
      "withdraw_table_network": "Ağ",
      "withdraw_table_status": "Durum",
      "withdraw_table_tx": "TX",
      "withdraw_table_action": "İşlem",
      "withdraw_loading": "Yükleniyor…",
      "withdraw_no_data": "Henüz talep yok",
      "withdraw_status_paid": "onaylandı",
      "withdraw_status_rejected": "reddedildi",
      "withdraw_status_pending": "beklemede",
      "withdraw_cancel_btn": "İptal",
    ...
    "it": {
      ...
      "deposit_wallet_label": "Portafoglio unificato (TRC20):",
      ...
      "deposit_note": "Dopo la conferma della rete, il saldo verrà rifornito automaticamente.",

      "withdraw_balance_label": "Saldo:",
      "withdraw_title": "Richiesta di prelievo",
      "withdraw_wallet_placeholder": "Portafoglio TRC20",
      "withdraw_amount_placeholder": "Importo prelievo, USDT",
      "withdraw_submit_btn": "Invia richiesta",
      "withdraw_note": "Primo prelievo — 5 giorni dopo l'attivazione. Poi — non più di una volta ogni 24 ore.",
      "withdraw_history_title": "Cronologia richieste",
      "withdraw_table_date": "Data",
      "withdraw_table_amount": "Importo",
      "withdraw_table_network": "Rete",
      "withdraw_table_status": "Stato",
      "withdraw_table_tx": "TX",
      "withdraw_table_action": "Azione",
      "withdraw_loading": "Caricamento…",
      "withdraw_no_data": "Nessuna richiesta ancora",
      "withdraw_status_paid": "confermato",
      "withdraw_status_rejected": "rifiutato",
      "withdraw_status_pending": "in attesa",
      "withdraw_cancel_btn": "Annulla",
      ...
      "no_data": "Nessun dato",
      "language": "Lingua",
      "language_switch": "Selezione lingua",
    ...
    "hi": {
      ...
      "deposit_title": "जमा",
      "deposit_wallet_label": "एकीकृत वॉलेट (TRC20):",
      ...
      "deposit_note": "नेटवर्क पुष्टि के बाद, बैलेंस स्वचालित रूप से भर दिया जाएगा।",

      "withdraw_balance_label": "बैलेंस:",
      "withdraw_title": "निकासी अनुरोध",
      "withdraw_wallet_placeholder": "TRC20 वॉलेट",
      "withdraw_amount_placeholder": "निकासी राशि, USDT",
      "withdraw_submit_btn": "अनुरोध सबमिट करें",
      "withdraw_note": "पहली निकासी — सक्रियण के 5 दिन बाद। फिर — 24 घंटे में एक बार से अधिक नहीं।",
      "withdraw_history_title": "अनुरोध इतिहास",
      "withdraw_table_date": "तारीख",
      "withdraw_table_amount": "राशि",
      "withdraw_table_network": "नेटवर्क",
      "withdraw_table_status": "स्थिति",
      "withdraw_table_tx": "TX",
      "withdraw_table_action": "कार्रवाई",
      "withdraw_loading": "लोड हो रहा है…",
      "withdraw_no_data": "अभी तक कोई अनुरोध नहीं",
      "withdraw_status_paid": "पुष्टि हुई",
      "withdraw_status_rejected": "अस्वीकृत",
      "withdraw_status_pending": "लंबित",
      "withdraw_cancel_btn": "रद्द करें",
    ...
    "pl": {
      ...
      "deposit_wallet_label": "Ujednolicony portfel (TRC20):",
      ...
      "deposit_note": "Po potwierdzeniu sieci, saldo zostanie automatycznie uzupełnione.",

      "withdraw_balance_label": "Saldo:",
      "withdraw_title": "Wniosek o wypłatę",
      "withdraw_wallet_placeholder": "Portfel TRC20",
      "withdraw_amount_placeholder": "Kwota wypłaty, USDT",
      "withdraw_submit_btn": "Wyślij wniosek",
      "withdraw_note": "Pierwsza wypłata — 5 dni po aktywacji. Następnie — nie częściej niż raz na 24 godziny.",
      "withdraw_history_title": "Historia wniosków",
      "withdraw_table_date": "Data",
      "withdraw_table_amount": "Kwota",
      "withdraw_table_network": "Sieć",
      "withdraw_table_status": "Status",
      "withdraw_table_tx": "TX",
      "withdraw_table_action": "Akcja",
      "withdraw_loading": "Ładowanie…",
      "withdraw_no_data": "Brak wniosków",
      "withdraw_status_paid": "potwierdzone",
      "withdraw_status_rejected": "odrzucone",
      "withdraw_status_pending": "oczekujące",
      "withdraw_cancel_btn": "Anuluj",
