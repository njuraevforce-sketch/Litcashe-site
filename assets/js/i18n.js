...
window.LC_I18N = (function(){
  ...
  let lang = localStorage.getItem('litcash_lang') || document.documentElement.getAttribute('lang') || 'ru';
  function t(key){ 
    const d = dict[lang] || {}; 
  ...
  function apply(){
    ...
    // Attribute bindings: data-i18n-attr="placeholder:login_email; title:btn_title"
  ...
  function setLang(l){ lang = l; localStorage.setItem('litcash_lang', l); }
  return { setLang, apply, t, dict };
})();
